    ...
    >
      ...
      >
        <div
          ...
          className="glass-3 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col shadow-black/5 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-lg"
        >
          {children}
        </div>
      </div>
